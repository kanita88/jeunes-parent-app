...
class ParentViewModel: ObservableObject {
    ...
    // Méthode pour ajouter un parent
        func addParent(id: UUID, nom: String, prenom: String, dateDeNaissance: String, motDePasse: String, motDePasseConfirmation: String, premiereExperienceParentale: Bool, enCouple: Bool) {
            ...
            let newParent = Parent(id: id, nom: nom, prenom: prenom, dateDeNaissance: dateDeNaissance, motDePasse: motDePasse, motDePasseConfirmation: motDePasseConfirmation, premiereExperienceParentale: premiereExperienceParentale, enCouple: enCouple)
